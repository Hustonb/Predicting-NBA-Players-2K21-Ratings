...
The purpose of the linked "Predicting NBA Player's 2K21 Ratings" writeup was to share our findings; along with an overview of the technical details that went into reaching that point. Note that only the "Predicting NBA Player's 2K21 Ratings" document was intended as a finished product. The other files are included as a zip file which is intended to show the step by step process we followed (via a Jupyter notebook); and allow anyone it interests to run this code themself. 
